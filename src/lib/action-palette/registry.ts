...
export const ACTIONS: ActionDef[] = [
  ...
  { id: "view-stock-reorder", label: "View stock reorder report", aliases: ["reorder report", "what to reorder", "low stock report", "restock", "below reorder point"], console: "Procurement", group: "Analytics", kind: "view", gate: { perm: P.PROC_VIEW_PROC_REPORTS }, run: { to: `${PR.ANALYTICS}/stock-reorder` } },
  { id: "view-stock-valuation", label: "View stock valuation report", aliases: ["stock valuation", "inventory value", "stock value report", "closing stock"], console: "Procurement", group: "Analytics", kind: "view", gate: { perm: P.PROC_VIEW_PROC_REPORTS }, run: { to: `${PR.ANALYTICS}/stock-valuation` } },
