...
export const ACTIONS: ActionDef[] = [
  ...
  { id: "create-permission-group", label: "Create permission group", aliases: ["new group", "bundle permissions"], console: "Main", group: "Permissions", kind: "do", gate: { perm: P.CREATE_PERMISSION_GROUP }, run: { to: R.ROLES.GROUPS.CREATE } },
  ...
  { id: "new-journal-entry", label: "New journal entry", aliases: ["create journal", "post journal", "direct entry"], console: "Finance", group: "Ledger & Setup", kind: "do", gate: { perm: P.FIN_POST_DIRECT_ENTRY }, run: { to: withAction(F.LEDGER) } },
  ...
  { id: "view-receipts", label: "View receipts", aliases: ["receipts & allocation", "receipts"], console: "Finance", group: "Receivables", kind: "view", gate: { perm: P.FIN_VIEW_PAYMENTS }, run: { to: F.RECEIPTS_ALLOCATION } },
  { id: "record-receipt", label: "Record receipt", aliases: ["new receipt", "record payment"], console: "Finance", group: "Receivables", kind: "do", gate: { perm: P.FIN_RECORD_PAYMENT }, run: { to: F.RECORD_PAYMENT } },
  ...
  { id: "create-payment-plan", label: "Create payment plan", aliases: ["new plan"], console: "Finance", group: "Receivables", kind: "do", gate: { all: [P.FIN_CREATE_PAYMENT_PLAN, P.FIN_ACTIVATE_PAYMENT_PLAN] }, run: { to: withAction(`${F.RECEIVABLES}/payment-plans`) } },
  ...
  { id: "import-bank-statement", label: "Import bank statement", aliases: ["upload statement"], console: "Finance", group: "Operations", kind: "do", gate: { perm: P.FIN_IMPORT_BANK }, run: { to: withAction(F.BANK_RECON, "import") } },
  ...
  { id: "create-requisition", label: "Create requisition", aliases: ["new requisition", "raise pr", "new pr", "create purchase requisition"], console: "Procurement", group: "Procure to Pay", kind: "do", gate: { perm: P.PROC_CREATE_REQUISITION }, run: { to: withAction(PR.REQUISITIONS) } },
  { id: "view-purchase-orders", label: "View purchase orders", aliases: ["po", "pos", "purchase order", "procurement orders"], console: "Procurement", group: "Procure to Pay", kind: "view", gate: { perm: P.PROC_VIEW_PURCHASE_ORDERS }, run: { to: PR.PURCHASE_ORDERS } },
  { id: "create-purchase-order", label: "Create purchase order", aliases: ["new po", "raise po", "new purchase order"], console: "Procurement", group: "Procure to Pay", kind: "do", gate: { perm: P.PROC_CREATE_PURCHASE_ORDER }, run: { to: withAction(PR.PURCHASE_ORDERS) } },
  { id: "view-goods-receipts", label: "View goods receipts", aliases: ["grn", "grns", "goods receipt note", "goods receipt notes", "received goods"], console: "Procurement", group: "Procure to Pay", kind: "view", gate: { perm: P.PROC_VIEW_GOODS_RECEIPTS }, run: { to: PR.GOODS_RECEIPTS } },
  { id: "post-goods-receipt", label: "Post goods receipt", aliases: ["new grn", "receive goods", "record goods receipt", "post grn"], console: "Procurement", group: "Procure to Pay", kind: "do", gate: { perm: P.PROC_CREATE_GOODS_RECEIPT }, run: { to: withAction(PR.GOODS_RECEIPTS) } },
  { id: "view-vendor-invoices", label: "View vendor invoices", aliases: ["ap invoice", "ap invoices", "supplier invoice", "supplier invoices", "accounts payable invoices"], console: "Procurement", group: "Procure to Pay", kind: "view", gate: { perm: P.PROC_VIEW_VENDOR_INVOICES }, run: { to: PR.VENDOR_INVOICES } },
  { id: "create-vendor-invoice", label: "Create vendor invoice", aliases: ["new vendor invoice", "new ap invoice", "record supplier invoice"], console: "Procurement", group: "Procure to Pay", kind: "do", gate: { perm: P.PROC_CREATE_VENDOR_INVOICE }, run: { to: withAction(PR.VENDOR_INVOICES) } },
  { id: "view-vendor-payments", label: "View vendor payments", aliases: ["ap payment", "ap payments", "supplier payment", "supplier payments", "accounts payable payments"], console: "Procurement", group: "Procure to Pay", kind: "view", gate: { perm: P.PROC_VIEW_VENDOR_PAYMENTS }, run: { to: PR.VENDOR_PAYMENTS } },
  { id: "new-vendor-payment", label: "New vendor payment", aliases: ["pay vendor", "pay supplier", "new payment", "new ap payment"], console: "Procurement", group: "Procure to Pay", kind: "do", gate: { perm: P.PROC_CREATE_VENDOR_PAYMENT }, run: { to: withAction(PR.VENDOR_PAYMENTS) } },

  // ── Procurement · Vendors & Catalog / Sourcing / Inventory / Analytics ───
  { id: "view-vendors", label: "View vendors", aliases: ["vendor", "supplier", "suppliers", "supplier master"], console: "Procurement", group: "Vendors & Catalog", kind: "view", gate: { perm: P.PROC_VIEW_VENDORS }, run: { to: `${PR.VENDORS}/vendors` } },
  { id: "create-vendor", label: "Create vendor", aliases: ["new vendor", "new supplier", "register supplier", "add supplier"], console: "Procurement", group: "Vendors & Catalog", kind: "do", gate: { perm: P.PROC_CREATE_VENDOR }, run: { to: withAction(`${PR.VENDORS}/vendors`) } },
  { id: "view-categories", label: "View categories", aliases: ["procurement categories", "purchasing categories"], console: "Procurement", group: "Vendors & Catalog", kind: "view", gate: { perm: P.PROC_VIEW_CATEGORIES }, run: { to: `${PR.VENDORS}/categories` } },
  { id: "create-category", label: "Create category", aliases: ["new category", "new procurement category"], console: "Procurement", group: "Vendors & Catalog", kind: "do", gate: { perm: P.PROC_CREATE_CATEGORY }, run: { to: withAction(`${PR.VENDORS}/categories`) } },
  { id: "view-catalog", label: "View catalog", aliases: ["catalog items", "procurement catalog", "product catalog"], console: "Procurement", group: "Vendors & Catalog", kind: "view", gate: { perm: P.PROC_VIEW_CATALOG }, run: { to: `${PR.VENDORS}/catalog` } },
  { id: "add-catalog-item", label: "Add catalog item", aliases: ["new item", "new catalog item", "add product"], console: "Procurement", group: "Vendors & Catalog", kind: "do", gate: { perm: P.PROC_CREATE_CATALOG_ITEM }, run: { to: withAction(`${PR.VENDORS}/catalog`) } },
  { id: "view-rfqs", label: "View RFQs", aliases: ["rfq", "request for quotation", "requests for quotation", "quotation requests"], console: "Procurement", group: "Sourcing", kind: "view", gate: { perm: P.PROC_VIEW_RFQS }, run: { to: `${PR.SOURCING}/rfqs` } },
  { id: "create-rfq", label: "Create RFQ", aliases: ["new rfq", "new request for quotation", "raise rfq"], console: "Procurement", group: "Sourcing", kind: "do", gate: { perm: P.PROC_CREATE_RFQ }, run: { to: withAction(`${PR.SOURCING}/rfqs`) } },
  { id: "view-quotations", label: "View quotations", aliases: ["quote", "quotes", "vendor quotes", "supplier quotations"], console: "Procurement", group: "Sourcing", kind: "view", gate: { perm: P.PROC_VIEW_QUOTATIONS }, run: { to: `${PR.SOURCING}/quotations` } },
  { id: "create-quotation", label: "Create quotation", aliases: ["new quote", "record quote", "new supplier quotation"], console: "Procurement", group: "Sourcing", kind: "do", gate: { perm: P.PROC_CREATE_QUOTATION }, run: { to: withAction(`${PR.SOURCING}/quotations`) } },
