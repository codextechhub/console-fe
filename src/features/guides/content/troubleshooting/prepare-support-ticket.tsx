  ...
  return (
    <div className="space-y-10">
      ...
      <GuideSection id="after-submission" title="After submission">
        <p>Keep the ticket number. Add new evidence to the same ticket instead of opening duplicates. If impact changes, update the ticket with the time and reason. Do not keep retrying a financial, import, approval, or provider action while support is tracing it unless the documented recovery path says it is safe.</p>
      </GuideSection>
