    ...
    <div className="space-y-10">
      ...
      <GuideSection id="create-the-role" title="Create or edit the role">
        <GuideSteps>
          ...
          <GuideStep title="Add individual permissions">Use <strong>Individual Permissions</strong> only for required access not already represented by the selected groups. Pick a module in the <strong>Module</strong> box, then a resource in the <strong>Resource</strong> box, which opens once a module is chosen. Both boxes search as you type, and choosing another module clears the resource. The resource&apos;s permissions then appear; tick them by their readable labels. <strong>Search permission labels</strong> narrows the chosen resource, and ticks made under one resource stay ticked when you move to another. A permission marked <strong>Approval required</strong> is restricted. A module or resource the current plan does not include is labelled <strong>not on the current plan</strong> and shows its reason once chosen; its permissions stay visible but cannot be ticked.</GuideStep>
      ...
      <GuideSection id="common-problems" title="Common problems">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
          {[
            ["A permission is not available", "Pick the module and resource it belongs to in the Module and Resource boxes, then search its label. A permission the current plan does not include shows its reason, and its tick box cannot be ticked."],
