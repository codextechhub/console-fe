  ...
  return (
    <div className="space-y-10">
      ...
      <GuideSection id="apply-channel-settings" title="Apply channel settings">
        ...
        <GuideCallout tone="tip" title="Queue tracking is not bell policy">Every attributed background job remains available in View Queues. Routine delivery work, such as password-reset, invitation, receipt, and review-request email jobs, stays out of the bell. Imports keep a completion alert because the operator waits for their result. Exports use their own ready or failed event, with the run link and email, instead of adding a second generic background-task alert.</GuideCallout>
      </GuideSection>
