...
function SidebarMenuSkeleton({
  ...
  // Pseudo-random width between 50 and 90%, derived from useId so the render
  // stays pure (Math.random() during render is unsafe under the React
  // Compiler) while each skeleton instance still gets a different width.
