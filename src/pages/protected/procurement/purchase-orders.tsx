...
export default function PurchaseOrdersPage() {
  ...
  const columns: Column<PurchaseOrder>[] = [
    {
      header: "PO Number",
      cell: (po) => <div className="min-w-32"><p className="font-mont text-xs font-semibold text-primary">{po.document_number}</p><p className="mt-1 max-w-56 truncate font-mont text-[11px] text-gray-05">{po.requisition_number || po.quotation_number || "Direct purchase order"}</p></div>,
    },
