...
export const arApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    ...
    createCustomer: builder.mutation<ApiEnvelope<Customer>, { entity: string; code: string; name: string; billing_email?: string; billing_phone?: string; billing_address?: string; receivable_account?: string; opening_balance?: number; opening_date?: string; is_active?: boolean }>({
