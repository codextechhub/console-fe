...
| Platform health and settings | Administer notification settings and templates | `platform.administer-notifications` | High | Published | Published | Console product team | 2026-08-21 | Covers bounded delivery history, channel policy, event contracts, unique event-channel templates, variables, backend preview, standard versus custom email design, activation, and controlled monitoring. Walkthrough never creates, edits, saves, activates, pauses, restores, or sends a notification |
